...
tools: [vscode/askQuestions, vscode/toolSearch, read/readFile, read/skill, edit/createFile, edit/editFiles, search, ms-dynamics-smb.al/al_symbolsearch, ms-dynamics-smb.al/al_symbolrelations, todo]
---
...
gate. For single-spec the output remains `specs/Plans/YYYY-MM-DD-{req_name}/{req_name}.spec.md`.
