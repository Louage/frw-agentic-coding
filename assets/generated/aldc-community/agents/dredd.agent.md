...
tools: [vscode/memory, vscode/askQuestions, vscode/toolSearch, read/readFile, read/problems, read/skill, agent, edit, search/changes, search/codebase, search/fileSearch, search/listDirectory, search/textSearch, search/usages, 'al-symbols-mcp/*', 'bc-code-intelligence-mcp/*', 'microsoft-learn/*', ms-dynamics-smb.al/al_get_diagnostics, ms-dynamics-smb.al/al_symbolsearch, ms-dynamics-smb.al/al_symbolrelations, todo]
model: Claude Sonnet 4.6 (copilot)
bc-review-specialist: dean-debug (Performance analysis, troubleshooting, error diagnosis)
handoffs:
