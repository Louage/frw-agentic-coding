---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/telemetry/telemetry-event-id-stable-unique.md
---

# Telemetry event IDs must be stable, unique, and non-placeholder

Source: microsoft/knowledge/telemetry/telemetry-event-id-stable-unique.md
