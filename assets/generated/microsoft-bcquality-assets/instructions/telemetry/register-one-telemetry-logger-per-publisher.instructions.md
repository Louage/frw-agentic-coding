---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/telemetry/register-one-telemetry-logger-per-publisher.md
---

# Register exactly one Telemetry Logger implementation per publisher

Source: microsoft/knowledge/telemetry/register-one-telemetry-logger-per-publisher.md
