---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/telemetry/match-verbosity-to-signal-severity.md
---

# Match telemetry Verbosity to the signal's actual severity

Source: microsoft/knowledge/telemetry/match-verbosity-to-signal-severity.md
