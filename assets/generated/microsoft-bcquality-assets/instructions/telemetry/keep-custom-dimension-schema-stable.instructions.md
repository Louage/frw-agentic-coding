---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/telemetry/keep-custom-dimension-schema-stable.md
---

# Treat custom dimension keys as a stable telemetry schema

Source: microsoft/knowledge/telemetry/keep-custom-dimension-schema-stable.md
