---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/testing/transactionmodel-attribute-governs-test-transactions.md
---

# Match TransactionModel to the commit behavior of the code under test

Source: microsoft/knowledge/testing/transactionmodel-attribute-governs-test-transactions.md
