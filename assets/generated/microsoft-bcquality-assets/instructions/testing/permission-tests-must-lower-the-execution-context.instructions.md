---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/testing/permission-tests-must-lower-the-execution-context.md
---

# Permission tests must actually lower the execution context

Source: microsoft/knowledge/testing/permission-tests-must-lower-the-execution-context.md
