---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/testing/use-library-codeunits-for-test-fixtures.md
---

# Build fixtures with the test Library codeunits, not hand-rolled Init/Insert

Source: microsoft/knowledge/testing/use-library-codeunits-for-test-fixtures.md
