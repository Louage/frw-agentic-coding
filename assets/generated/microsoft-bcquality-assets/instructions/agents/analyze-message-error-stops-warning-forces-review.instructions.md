---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/analyze-message-error-stops-warning-forces-review.md
---

# AnalyzeAgentTaskMessage: Error stops the task; Warning still requires review

Source: community/knowledge/agents/analyze-message-error-stops-warning-forces-review.md
