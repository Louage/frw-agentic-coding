---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/show-can-create-agent-does-not-block-code-create.md
---

# ShowCanCreateAgent only hides UI create, not programmatic create

Source: community/knowledge/agents/show-can-create-agent-does-not-block-code-create.md
