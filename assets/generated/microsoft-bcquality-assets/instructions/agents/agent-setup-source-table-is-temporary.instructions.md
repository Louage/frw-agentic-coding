---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/agent-setup-source-table-is-temporary.md
---

# Keep the agent setup page source temporary until Update

Source: community/knowledge/agents/agent-setup-source-table-is-temporary.md
