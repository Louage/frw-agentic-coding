---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/wire-all-three-agent-interfaces.md
---

# Wire all three agent interfaces on the metadata provider

Source: community/knowledge/agents/wire-all-three-agent-interfaces.md
