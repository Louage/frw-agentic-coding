---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/web-services/disable-write-operations-on-read-only-api-pages.md
---

# Lock down write operations on read-only API pages

Source: microsoft/knowledge/web-services/disable-write-operations-on-read-only-api-pages.md
