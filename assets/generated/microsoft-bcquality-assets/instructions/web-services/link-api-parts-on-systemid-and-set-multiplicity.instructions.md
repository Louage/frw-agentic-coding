---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/web-services/link-api-parts-on-systemid-and-set-multiplicity.md
---

# Link API parts on SystemId and choose the correct multiplicity

Source: microsoft/knowledge/web-services/link-api-parts-on-systemid-and-set-multiplicity.md
