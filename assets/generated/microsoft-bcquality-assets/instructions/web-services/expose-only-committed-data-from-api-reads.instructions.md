---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/web-services/expose-only-committed-data-from-api-reads.md
---

# Read only committed data from APIs that must not expose in-flight writes

Source: microsoft/knowledge/web-services/expose-only-committed-data-from-api-reads.md
