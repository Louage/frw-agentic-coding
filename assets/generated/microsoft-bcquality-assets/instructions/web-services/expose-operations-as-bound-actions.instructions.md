---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/web-services/expose-operations-as-bound-actions.md
---

# Expose business operations as bound actions, not as writable status flags

Source: microsoft/knowledge/web-services/expose-operations-as-bound-actions.md
