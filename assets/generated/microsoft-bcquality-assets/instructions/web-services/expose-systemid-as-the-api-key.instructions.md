---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/web-services/expose-systemid-as-the-api-key.md
---

# Address API records by SystemId, not by a renamable business key

Source: microsoft/knowledge/web-services/expose-systemid-as-the-api-key.md
