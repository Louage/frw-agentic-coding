---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/findset-true-applies-updlock-on-read.md
---

# FindSet(true) applies UpdLock on the read; the two-parameter form is obsolete

Source: microsoft/knowledge/performance/findset-true-applies-updlock-on-read.md
