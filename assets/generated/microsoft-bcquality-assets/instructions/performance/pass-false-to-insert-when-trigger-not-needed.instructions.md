---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/pass-false-to-insert-when-trigger-not-needed.md
---

# Pass false to Insert/Modify/Delete when the table triggers do not need to fire

Source: microsoft/knowledge/performance/pass-false-to-insert-when-trigger-not-needed.md
