---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/load-only-primary-key-fields-for-reference-work.md
---

# Load only primary key fields for reference work

Source: microsoft/knowledge/performance/load-only-primary-key-fields-for-reference-work.md
