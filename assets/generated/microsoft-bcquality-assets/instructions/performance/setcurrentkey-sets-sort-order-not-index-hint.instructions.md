---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/setcurrentkey-sets-sort-order-not-index-hint.md
---

# SetCurrentKey only sets sort order, it is not an index hint

Source: microsoft/knowledge/performance/setcurrentkey-sets-sort-order-not-index-hint.md
