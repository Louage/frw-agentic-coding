---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/codeunit-run-requires-prior-commit-inside-transaction.md
---

# Commit before Codeunit.Run when the caller already holds a write transaction

Source: microsoft/knowledge/performance/codeunit-run-requires-prior-commit-inside-transaction.md
