---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/hidden-flowfields-still-calculate-before-bc26-opt-in.md
---

# Hidden page FlowFields still calculate unless visible-only calculation is enabled

Source: microsoft/knowledge/performance/hidden-flowfields-still-calculate-before-bc26-opt-in.md
