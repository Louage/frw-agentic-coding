---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/avoid-redundant-get-when-record-already-loaded.md
---

# Do not Get the record the page already loaded

Source: microsoft/knowledge/performance/avoid-redundant-get-when-record-already-loaded.md
