---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/reset-clears-partial-record-selection.md
---

# Reset and empty SetLoadFields restore a full-row load

Source: community/knowledge/performance/reset-clears-partial-record-selection.md
