---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/reset-clears-partial-record-selection.md
---

# Reset and empty SetLoadFields restore a full-row load

Source: microsoft/knowledge/performance/reset-clears-partial-record-selection.md
