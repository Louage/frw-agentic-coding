---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/job-queue-handlers-must-not-require-ui.md
---

# Job queue handlers must not require user interaction

Source: microsoft/knowledge/performance/job-queue-handlers-must-not-require-ui.md
