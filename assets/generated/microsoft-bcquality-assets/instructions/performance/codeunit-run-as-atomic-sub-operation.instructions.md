---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/codeunit-run-as-atomic-sub-operation.md
---

# Use Codeunit.Run to bound an atomic sub-operation

Source: microsoft/knowledge/performance/codeunit-run-as-atomic-sub-operation.md
