---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/calcfields-in-both-getrecord-triggers-is-not-redundant.md
---

# CalcFields in both OnAfterGetRecord and OnAfterGetCurrRecord is not redundant

Source: microsoft/knowledge/performance/calcfields-in-both-getrecord-triggers-is-not-redundant.md
