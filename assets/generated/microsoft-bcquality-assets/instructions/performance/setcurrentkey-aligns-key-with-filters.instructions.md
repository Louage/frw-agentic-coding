---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/setcurrentkey-aligns-key-with-filters.md
---

# Pick a key whose fields cover the filter and sort with SetCurrentKey

Source: microsoft/knowledge/performance/setcurrentkey-aligns-key-with-filters.md
