---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/use-isempty-for-existence-check.md
---

# Use IsEmpty for existence checks, not Count() or FindFirst()

Source: microsoft/knowledge/performance/use-isempty-for-existence-check.md
