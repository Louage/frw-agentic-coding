---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/admin-and-migration-pages-tolerate-lower-perf.md
---

# Admin and migration pages tolerate lower performance discipline

Source: microsoft/knowledge/performance/admin-and-migration-pages-tolerate-lower-perf.md
