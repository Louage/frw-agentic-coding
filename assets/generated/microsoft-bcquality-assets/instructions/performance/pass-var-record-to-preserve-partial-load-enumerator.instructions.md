---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/pass-var-record-to-preserve-partial-load-enumerator.md
---

# Pass the iterated record var so a JIT load updates the enumerator

Source: community/knowledge/performance/pass-var-record-to-preserve-partial-load-enumerator.md
