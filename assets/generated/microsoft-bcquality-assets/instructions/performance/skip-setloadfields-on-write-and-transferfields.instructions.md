---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/skip-setloadfields-on-write-and-transferfields.md
---

# Skip SetLoadFields on write and copy paths

Source: microsoft/knowledge/performance/skip-setloadfields-on-write-and-transferfields.md
