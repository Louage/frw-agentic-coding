---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/use-tryfunction-for-error-catching-not-rollback.md
---

# Use [TryFunction] for error catching, Codeunit.Run for atomic rollback

Source: microsoft/knowledge/performance/use-tryfunction-for-error-catching-not-rollback.md
