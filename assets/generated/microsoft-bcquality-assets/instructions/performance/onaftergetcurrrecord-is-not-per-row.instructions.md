---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/onaftergetcurrrecord-is-not-per-row.md
---

# Database work in OnAfterGetCurrRecord is not a per-row or N+1 cost

Source: microsoft/knowledge/performance/onaftergetcurrrecord-is-not-per-row.md
