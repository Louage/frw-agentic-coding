---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/omit-filter-only-fields-from-setloadfields.md
---

# Omit filter-only fields from SetLoadFields

Source: microsoft/knowledge/performance/omit-filter-only-fields-from-setloadfields.md
