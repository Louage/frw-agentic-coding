---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/job-queue-on-hold-does-not-stop-running-work.md
---

# Putting a job queue entry on hold does not stop its current run

Source: microsoft/knowledge/performance/job-queue-on-hold-does-not-stop-running-work.md
