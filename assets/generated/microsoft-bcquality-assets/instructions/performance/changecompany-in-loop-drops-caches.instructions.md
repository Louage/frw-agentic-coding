---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/changecompany-in-loop-drops-caches.md
---

# Do not call ChangeCompany inside a per-row loop

Source: community/knowledge/performance/changecompany-in-loop-drops-caches.md
