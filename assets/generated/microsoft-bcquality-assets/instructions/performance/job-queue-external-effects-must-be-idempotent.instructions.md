---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/job-queue-external-effects-must-be-idempotent.md
---

# Job queue external effects must be idempotent

Source: microsoft/knowledge/performance/job-queue-external-effects-must-be-idempotent.md
