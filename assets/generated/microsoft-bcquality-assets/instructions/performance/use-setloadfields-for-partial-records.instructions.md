---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/use-setloadfields-for-partial-records.md
---

# Use SetLoadFields to load only the fields the code reads

Source: microsoft/knowledge/performance/use-setloadfields-for-partial-records.md
