---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/use-get-instead-of-findfirst-on-full-primary-key.md
---

# Use Get when the full primary key is known; FindFirst is the wrong tool

Source: microsoft/knowledge/performance/use-get-instead-of-findfirst-on-full-primary-key.md
