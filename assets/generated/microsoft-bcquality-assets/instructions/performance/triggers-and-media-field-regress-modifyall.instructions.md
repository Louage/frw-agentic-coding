---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/triggers-and-media-field-regress-modifyall.md
---

# Triggers, subscribers, and media fields can silently regress ModifyAll / DeleteAll

Source: microsoft/knowledge/performance/triggers-and-media-field-regress-modifyall.md
