---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/maintainsqlindex-false-breaks-flowfield-sift.md
---

# MaintainSQLIndex = false on a key disables SIFT for FlowFields that depend on it

Source: microsoft/knowledge/performance/maintainsqlindex-false-breaks-flowfield-sift.md
