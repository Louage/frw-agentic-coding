---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/query-results-bypass-primary-key-cache.md
---

# Query results bypass the primary-key cache

Source: microsoft/knowledge/performance/query-results-bypass-primary-key-cache.md
