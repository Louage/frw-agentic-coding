---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/do-not-remove-sourcetabletemporary-from-api-page.md
---

# Removing SourceTableTemporary on an API page switches it from in-memory to persistent

Source: microsoft/knowledge/performance/do-not-remove-sourcetabletemporary-from-api-page.md
