---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/store-scheduled-task-id-to-avoid-duplicate-tasks.md
---

# Store the scheduled task ID to avoid duplicate tasks

Source: microsoft/knowledge/performance/store-scheduled-task-id-to-avoid-duplicate-tasks.md
