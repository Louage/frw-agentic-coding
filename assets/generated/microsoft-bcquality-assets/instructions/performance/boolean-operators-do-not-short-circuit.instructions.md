---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/boolean-operators-do-not-short-circuit.md
---

# AL boolean operators do not short-circuit

Source: microsoft/knowledge/performance/boolean-operators-do-not-short-circuit.md
