---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/flowfield-source-key-needs-sumindexfields.md
---

# A FlowField needs a source-table key that covers its CalcFormula

Source: microsoft/knowledge/performance/flowfield-source-key-needs-sumindexfields.md
