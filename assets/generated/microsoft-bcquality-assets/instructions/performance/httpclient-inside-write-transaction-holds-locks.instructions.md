---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/httpclient-inside-write-transaction-holds-locks.md
---

# Do not call HttpClient inside an open write transaction

Source: community/knowledge/performance/httpclient-inside-write-transaction-holds-locks.md
