---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/skip-nonessential-work-via-execution-context.md
---

# Skip non-essential runtime work when `GetExecutionContext() = ExecutionContext::Upgrade`

Source: microsoft/knowledge/upgrade/skip-nonessential-work-via-execution-context.md
