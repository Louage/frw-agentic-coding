---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/first-install-dataversion-zero-check.md
---

# Detect first install with `DataVersion() = Version.Create('0.0.0.0')`

Source: microsoft/knowledge/upgrade/first-install-dataversion-zero-check.md
