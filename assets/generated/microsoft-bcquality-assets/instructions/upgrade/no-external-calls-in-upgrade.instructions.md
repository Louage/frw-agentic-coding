---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/no-external-calls-in-upgrade.md
---

# No external calls inside upgrade codeunits

Source: microsoft/knowledge/upgrade/no-external-calls-in-upgrade.md
