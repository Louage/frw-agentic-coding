---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/do-not-block-upgrade-on-data-errors.md
---

# Log telemetry; do not raise errors that block the upgrade

Source: microsoft/knowledge/upgrade/do-not-block-upgrade-on-data-errors.md
