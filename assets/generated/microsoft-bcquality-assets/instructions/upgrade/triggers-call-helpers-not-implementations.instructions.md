---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/triggers-call-helpers-not-implementations.md
---

# `OnUpgradePerCompany` / `OnUpgradePerDatabase` should call helpers, not inline logic

Source: microsoft/knowledge/upgrade/triggers-call-helpers-not-implementations.md
