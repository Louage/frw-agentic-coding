---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/initvalue-does-not-update-existing-rows.md
---

# `InitValue` does not back-fill existing rows

Source: microsoft/knowledge/upgrade/initvalue-does-not-update-existing-rows.md
