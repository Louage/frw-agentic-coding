---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/obsolete-pending-to-removed-staging.md
---

# Stage obsoletion `Pending → Removed`; write upgrade code on removal

Source: microsoft/knowledge/upgrade/obsolete-pending-to-removed-staging.md
