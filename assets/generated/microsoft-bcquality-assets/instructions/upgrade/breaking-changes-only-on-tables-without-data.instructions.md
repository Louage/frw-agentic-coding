---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/breaking-changes-only-on-tables-without-data.md
---

# Primary-key and field-type changes are safe only on tables without existing data

Source: microsoft/knowledge/upgrade/breaking-changes-only-on-tables-without-data.md
