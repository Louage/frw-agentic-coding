---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/guard-database-reads.md
---

# Guard every database read in upgrade code with `if`

Source: microsoft/knowledge/upgrade/guard-database-reads.md
