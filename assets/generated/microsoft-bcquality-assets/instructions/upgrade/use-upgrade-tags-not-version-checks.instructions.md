---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/use-upgrade-tags-not-version-checks.md
---

# Control upgrade execution with upgrade tags, not version checks

Source: microsoft/knowledge/upgrade/use-upgrade-tags-not-version-checks.md
