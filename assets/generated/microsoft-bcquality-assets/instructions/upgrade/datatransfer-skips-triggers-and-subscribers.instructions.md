---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/datatransfer-skips-triggers-and-subscribers.md
---

# `DataTransfer` does not fire validation triggers or event subscribers

Source: microsoft/knowledge/upgrade/datatransfer-skips-triggers-and-subscribers.md
