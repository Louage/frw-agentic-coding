---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/datatransfer-for-bulk-init.md
---

# Use `DataTransfer` for bulk updates on large tables

Source: microsoft/knowledge/upgrade/datatransfer-for-bulk-init.md
