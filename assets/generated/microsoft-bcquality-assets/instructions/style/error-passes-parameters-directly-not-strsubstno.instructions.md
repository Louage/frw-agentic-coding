---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/error-passes-parameters-directly-not-strsubstno.md
---

# Pass parameters directly to `Error()`, do not wrap with `StrSubstNo`

Source: microsoft/knowledge/style/error-passes-parameters-directly-not-strsubstno.md
