---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/variable-declaration-order-by-type.md
---

# Order variable declarations by type, complex types first (CodeCop AA0021)

Source: microsoft/knowledge/style/variable-declaration-order-by-type.md
