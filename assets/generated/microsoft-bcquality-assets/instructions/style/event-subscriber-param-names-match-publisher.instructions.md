---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/event-subscriber-param-names-match-publisher.md
---

# Event subscriber parameter names must match the publisher signature

Source: microsoft/knowledge/style/event-subscriber-param-names-match-publisher.md
