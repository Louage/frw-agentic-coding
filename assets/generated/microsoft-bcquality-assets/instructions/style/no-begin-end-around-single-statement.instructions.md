---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/no-begin-end-around-single-statement.md
---

# Do not wrap a single statement in `begin … end` (CodeCop AA0013)

Source: microsoft/knowledge/style/no-begin-end-around-single-statement.md
