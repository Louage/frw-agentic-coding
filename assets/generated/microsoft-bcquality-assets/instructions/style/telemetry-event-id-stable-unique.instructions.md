---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/telemetry-event-id-stable-unique.md
---

# Telemetry event IDs must be stable, unique, and non-placeholder

Source: microsoft/knowledge/style/telemetry-event-id-stable-unique.md
