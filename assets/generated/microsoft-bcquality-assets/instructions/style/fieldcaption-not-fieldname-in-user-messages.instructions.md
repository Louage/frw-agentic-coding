---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/fieldcaption-not-fieldname-in-user-messages.md
---

# Use FieldCaption/TableCaption (not FieldName/TableName) in user-facing text

Source: microsoft/knowledge/style/fieldcaption-not-fieldname-in-user-messages.md
