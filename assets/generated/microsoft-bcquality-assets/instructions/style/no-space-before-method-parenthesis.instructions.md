---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/no-space-before-method-parenthesis.md
---

# No space between a method name and its opening parenthesis (CodeCop AA0002)

Source: microsoft/knowledge/style/no-space-before-method-parenthesis.md
