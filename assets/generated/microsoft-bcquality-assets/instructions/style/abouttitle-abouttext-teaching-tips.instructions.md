---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/abouttitle-abouttext-teaching-tips.md
---

# Use `AboutTitle` and `AboutText` to surface teaching tips on top-level pages

Source: microsoft/knowledge/style/abouttitle-abouttext-teaching-tips.md
