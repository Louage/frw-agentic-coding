---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/file-name-object-type-pattern.md
---

# Name AL source files `<ObjectName>.<ObjectType>.al`

Source: microsoft/knowledge/style/file-name-object-type-pattern.md
