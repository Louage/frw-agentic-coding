---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/case-action-on-line-after-possibility.md
---

# `case` action goes on the line after the possibility

Source: microsoft/knowledge/style/case-action-on-line-after-possibility.md
