---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/api-page-camelcase-properties.md
---

# API pages use camelCase, alphanumeric-only values for API properties

Source: microsoft/knowledge/style/api-page-camelcase-properties.md
