---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/named-invocations-not-object-ids.md
---

# Call objects by name, not by numeric ID

Source: microsoft/knowledge/style/named-invocations-not-object-ids.md
