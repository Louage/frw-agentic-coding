---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/temporary-variable-temp-prefix.md
---

# Prefix temporary record variables with `Temp`

Source: microsoft/knowledge/style/temporary-variable-temp-prefix.md
