---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/applicationarea-required-on-page-controls.md
---

# Every page control needs an `ApplicationArea` (AppSourceCop AS0062)

Source: microsoft/knowledge/style/applicationarea-required-on-page-controls.md
