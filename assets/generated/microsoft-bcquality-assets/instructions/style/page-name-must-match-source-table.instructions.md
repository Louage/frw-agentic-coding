---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/page-name-must-match-source-table.md
---

# A page or view name must describe the table it shows

Source: microsoft/knowledge/style/page-name-must-match-source-table.md
