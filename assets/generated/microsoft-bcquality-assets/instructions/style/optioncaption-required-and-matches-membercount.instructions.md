---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/optioncaption-required-and-matches-membercount.md
---

# Option fields need `OptionCaption`, and its element count must match `OptionMembers` (CodeCop AA0221/AA0223/AA0224)

Source: microsoft/knowledge/style/optioncaption-required-and-matches-membercount.md
