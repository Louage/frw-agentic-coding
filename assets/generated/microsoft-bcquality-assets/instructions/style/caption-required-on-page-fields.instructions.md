---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/caption-required-on-page-fields.md
---

# Every page field needs a `Caption` (CodeCop AA0225/AA0226)

Source: microsoft/knowledge/style/caption-required-on-page-fields.md
