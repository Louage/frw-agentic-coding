---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/api-page-version-format.md
---

# `APIVersion` must follow the pattern `vX.Y` (or `beta`)

Source: microsoft/knowledge/style/api-page-version-format.md
