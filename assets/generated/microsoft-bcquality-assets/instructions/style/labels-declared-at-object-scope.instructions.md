---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/labels-declared-at-object-scope.md
---

# Declare Labels at object scope, not inside procedure `var` blocks

Source: microsoft/knowledge/style/labels-declared-at-object-scope.md
