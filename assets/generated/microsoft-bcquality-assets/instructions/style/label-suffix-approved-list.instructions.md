---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/label-suffix-approved-list.md
---

# Use approved suffixes on Label and TextConst names (CodeCop AA0074)

Source: microsoft/knowledge/style/label-suffix-approved-list.md
