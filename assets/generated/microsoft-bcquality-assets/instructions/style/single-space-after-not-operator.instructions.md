---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/single-space-after-not-operator.md
---

# Exactly one space between `not` and its argument (CodeCop AA0003)

Source: microsoft/knowledge/style/single-space-after-not-operator.md
