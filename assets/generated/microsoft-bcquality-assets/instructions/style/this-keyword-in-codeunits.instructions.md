---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/this-keyword-in-codeunits.md
---

# Use the `this` keyword for self-reference inside codeunits (CodeCop AA0248)

Source: microsoft/knowledge/style/this-keyword-in-codeunits.md
