---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/block-keywords-start-new-line.md
---

# Block keywords (`end`, `if`, `repeat`, `until`, `for`, `while`, `case`) start a new line (CodeCop AA0018)

Source: microsoft/knowledge/style/block-keywords-start-new-line.md
