---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/single-space-around-binary-operators.md
---

# One space on each side of every binary operator (CodeCop AA0001)

Source: microsoft/knowledge/style/single-space-around-binary-operators.md
