---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/begin-on-same-line-as-then-else-do.md
---

# `begin` goes on the same line as `then`, `else`, or `do` (CodeCop AA0005)

Source: microsoft/knowledge/style/begin-on-same-line-as-then-else-do.md
