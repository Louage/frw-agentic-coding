---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/validatetablerelation-false-on-user-input.md
---

# Handle free-form input when ValidateTableRelation is false

Source: microsoft/knowledge/security/validatetablerelation-false-on-user-input.md
