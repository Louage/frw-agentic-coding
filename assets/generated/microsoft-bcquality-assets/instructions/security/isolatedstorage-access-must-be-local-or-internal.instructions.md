---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/isolatedstorage-access-must-be-local-or-internal.md
---

# Procedures that read or write IsolatedStorage must not be public

Source: microsoft/knowledge/security/isolatedstorage-access-must-be-local-or-internal.md
