---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/secrettext-with-httpclient.md
---

# Set secret request URIs on HttpRequestMessage

Source: microsoft/knowledge/security/secrettext-with-httpclient.md
