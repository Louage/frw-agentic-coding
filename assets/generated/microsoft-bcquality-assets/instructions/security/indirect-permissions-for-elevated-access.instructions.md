---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/indirect-permissions-for-elevated-access.md
---

# Use indirect permissions when access must be code-mediated

Source: microsoft/knowledge/security/indirect-permissions-for-elevated-access.md
