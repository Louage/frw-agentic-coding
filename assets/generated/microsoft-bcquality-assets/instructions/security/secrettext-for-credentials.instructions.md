---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/secrettext-for-credentials.md
---

# Use SecretText for credentials, API keys, and tokens

Source: microsoft/knowledge/security/secrettext-for-credentials.md
