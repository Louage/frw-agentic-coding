---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/getlasterrortext-storage-is-privacy-not-security.md
---

# Storing GetLastErrorText() in table fields is a privacy finding, not a security finding

Source: microsoft/knowledge/security/getlasterrortext-storage-is-privacy-not-security.md
