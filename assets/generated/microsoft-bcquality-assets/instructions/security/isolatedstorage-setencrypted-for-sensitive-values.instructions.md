---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/isolatedstorage-setencrypted-for-sensitive-values.md
---

# Prefer IsolatedStorage.SetEncrypted over Set for sensitive values

Source: microsoft/knowledge/security/isolatedstorage-setencrypted-for-sensitive-values.md
