---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/permission-set-avoid-wildcard-grants.md
---

# Avoid wildcard grants in permission sets

Source: microsoft/knowledge/security/permission-set-avoid-wildcard-grants.md
