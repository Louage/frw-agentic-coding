---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/recordref-open-with-caller-table-must-not-be-public.md
---

# Procedures that RecordRef.Open a caller-provided table must not be public

Source: microsoft/knowledge/security/recordref-open-with-caller-table-must-not-be-public.md
