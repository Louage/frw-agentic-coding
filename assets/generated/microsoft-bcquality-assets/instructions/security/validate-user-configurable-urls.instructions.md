---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/validate-user-configurable-urls.md
---

# Validate URLs that come from table fields before calling them

Source: microsoft/knowledge/security/validate-user-configurable-urls.md
