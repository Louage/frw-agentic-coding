---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/validate-unauthenticated-response-before-use.md
---

# Validate responses from unauthenticated endpoints before trusting them

Source: microsoft/knowledge/security/validate-unauthenticated-response-before-use.md
