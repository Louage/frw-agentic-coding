---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/integrationevent-var-parameter-bypasses-security-guards.md
---

# Do not expose security guards as `var` parameters on IntegrationEvent

Source: microsoft/knowledge/security/integrationevent-var-parameter-bypasses-security-guards.md
