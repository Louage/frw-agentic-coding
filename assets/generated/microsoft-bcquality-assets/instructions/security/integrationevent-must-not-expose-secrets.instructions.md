---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/integrationevent-must-not-expose-secrets.md
---

# Do not pass credentials or secrets through IntegrationEvent parameters

Source: microsoft/knowledge/security/integrationevent-must-not-expose-secrets.md
