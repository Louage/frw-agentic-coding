---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/isolatedstorage-datascope-module-vs-company.md
---

# Pick the right IsolatedStorage DataScope for the secret's lifetime

Source: microsoft/knowledge/security/isolatedstorage-datascope-module-vs-company.md
