---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/commitbehavior-attribute-scopes-explicit-commits.md
---

# Use [CommitBehavior] to protect an atomic operation from third-party commits

Source: microsoft/knowledge/security/commitbehavior-attribute-scopes-explicit-commits.md
