---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/error-handling/prefer-errorinfo-for-actionable-errors.md
---

# Prefer ErrorInfo with recommended actions over a plain Error for recoverable failures

Source: microsoft/knowledge/error-handling/prefer-errorinfo-for-actionable-errors.md
