---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/error-handling/unchecked-get-throws-when-record-not-found.md
---

# An unchecked Record.Get raises an error when the record is missing; it is not silently ignored

Source: microsoft/knowledge/error-handling/unchecked-get-throws-when-record-not-found.md
