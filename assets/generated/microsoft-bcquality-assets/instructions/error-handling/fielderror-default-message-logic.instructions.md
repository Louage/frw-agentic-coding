---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/error-handling/fielderror-default-message-logic.md
---

# Rely On FieldError's Auto-Generated Context And Pass Only A Lowercase Predicate

Source: microsoft/knowledge/error-handling/fielderror-default-message-logic.md
