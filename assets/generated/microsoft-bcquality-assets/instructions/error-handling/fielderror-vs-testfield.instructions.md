---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/error-handling/fielderror-vs-testfield.md
---

# Choose `TestField` For Conditional Checks And `FieldError` For Already-Failed Validation

Source: community/knowledge/error-handling/fielderror-vs-testfield.md
