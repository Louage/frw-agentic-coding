---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/error-handling/collect-validation-errors-with-errorbehavior.md
---

# Collect validation errors with ErrorBehavior::Collect and handle the collected list

Source: microsoft/knowledge/error-handling/collect-validation-errors-with-errorbehavior.md
