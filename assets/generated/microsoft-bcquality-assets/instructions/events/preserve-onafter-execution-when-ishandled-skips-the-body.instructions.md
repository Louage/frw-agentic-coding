---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/preserve-onafter-execution-when-ishandled-skips-the-body.md
---

# Preserve OnAfter execution when IsHandled skips the body

Source: microsoft/knowledge/events/preserve-onafter-execution-when-ishandled-skips-the-body.md
