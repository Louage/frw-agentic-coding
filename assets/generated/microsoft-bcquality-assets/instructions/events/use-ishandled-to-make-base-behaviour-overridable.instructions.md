---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/use-ishandled-to-make-base-behaviour-overridable.md
---

# Use the IsHandled pattern to make base behaviour overridable

Source: microsoft/knowledge/events/use-ishandled-to-make-base-behaviour-overridable.md
