---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/avoid-loosely-typed-event-parameters.md
---

# Avoid loosely typed event parameters

Source: microsoft/knowledge/events/avoid-loosely-typed-event-parameters.md
