---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/do-not-add-ishandled-to-an-existing-event.md
---

# Do not add IsHandled to an existing event

Source: microsoft/knowledge/events/do-not-add-ishandled-to-an-existing-event.md
