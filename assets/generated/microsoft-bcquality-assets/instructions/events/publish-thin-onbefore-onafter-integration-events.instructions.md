---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/publish-thin-onbefore-onafter-integration-events.md
---

# Publish thin OnBefore/OnAfter integration events to expose extension points

Source: microsoft/knowledge/events/publish-thin-onbefore-onafter-integration-events.md
