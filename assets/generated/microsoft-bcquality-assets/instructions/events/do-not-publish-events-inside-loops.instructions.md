---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/do-not-publish-events-inside-loops.md
---

# Do not publish events inside loops

Source: microsoft/knowledge/events/do-not-publish-events-inside-loops.md
