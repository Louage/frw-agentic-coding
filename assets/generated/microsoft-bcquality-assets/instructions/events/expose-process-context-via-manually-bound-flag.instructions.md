---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/expose-process-context-via-manually-bound-flag.md
---

# Expose process context through a manually bound flag, not a single-instance boolean

Source: microsoft/knowledge/events/expose-process-context-via-manually-bound-flag.md
