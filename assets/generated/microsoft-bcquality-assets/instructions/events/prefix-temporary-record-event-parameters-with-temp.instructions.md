---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/prefix-temporary-record-event-parameters-with-temp.md
---

# Prefix temporary record event parameters with Temp

Source: microsoft/knowledge/events/prefix-temporary-record-event-parameters-with-temp.md
