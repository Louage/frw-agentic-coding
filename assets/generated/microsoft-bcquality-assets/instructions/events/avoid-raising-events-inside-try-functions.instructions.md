---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/avoid-raising-events-inside-try-functions.md
---

# Do not raise integration events inside a TryFunction

Source: microsoft/knowledge/events/avoid-raising-events-inside-try-functions.md
