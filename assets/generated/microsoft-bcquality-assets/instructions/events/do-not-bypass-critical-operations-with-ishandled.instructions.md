---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/do-not-bypass-critical-operations-with-ishandled.md
---

# Do not bypass critical operations with IsHandled

Source: microsoft/knowledge/events/do-not-bypass-critical-operations-with-ishandled.md
