---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/reporting/report-output-in-a-loop-needs-one-client-download.md
---

# Report output in a loop needs one client download

Source: microsoft/knowledge/reporting/report-output-in-a-loop-needs-one-client-download.md
