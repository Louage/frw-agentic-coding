---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/reporting/reportextension-report-triggers-run-after-base-triggers.md
---

# ReportExtension report triggers run after base report triggers

Source: microsoft/knowledge/reporting/reportextension-report-triggers-run-after-base-triggers.md
