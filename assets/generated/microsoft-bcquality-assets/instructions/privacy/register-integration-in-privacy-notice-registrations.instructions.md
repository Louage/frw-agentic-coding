---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/register-integration-in-privacy-notice-registrations.md
---

# Register every new external integration with `Privacy Notice Registrations`

Source: microsoft/knowledge/privacy/register-integration-in-privacy-notice-registrations.md
