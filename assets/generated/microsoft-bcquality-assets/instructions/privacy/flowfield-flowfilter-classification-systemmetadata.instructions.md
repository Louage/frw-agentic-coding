---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/flowfield-flowfilter-classification-systemmetadata.md
---

# FlowFields and FlowFilters are classified `SystemMetadata` automatically

Source: microsoft/knowledge/privacy/flowfield-flowfilter-classification-systemmetadata.md
