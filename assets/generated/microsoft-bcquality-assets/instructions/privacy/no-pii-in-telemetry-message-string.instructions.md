---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/no-pii-in-telemetry-message-string.md
---

# Do not embed customer data in the telemetry message text

Source: microsoft/knowledge/privacy/no-pii-in-telemetry-message-string.md
