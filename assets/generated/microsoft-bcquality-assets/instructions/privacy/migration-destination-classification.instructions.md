---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/migration-destination-classification.md
---

# In data migration code, classify the destination, not the migration itself

Source: microsoft/knowledge/privacy/migration-destination-classification.md
