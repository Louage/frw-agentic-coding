---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/breaking-changes/do-not-expose-sensitive-data-through-public-api.md
---

# Do not widen access to expose sensitive data through a public API

Source: microsoft/knowledge/breaking-changes/do-not-expose-sensitive-data-through-public-api.md
