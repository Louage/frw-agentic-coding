---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/breaking-changes/do-not-modify-code-already-marked-obsolete.md
---

# Do not build on code already marked obsolete

Source: microsoft/knowledge/breaking-changes/do-not-modify-code-already-marked-obsolete.md
