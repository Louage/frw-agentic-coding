---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/breaking-changes/relocating-a-field-to-a-tableextension-is-not-a-deletion.md
---

# Relocating a field to a tableextension in the same app is not a deletion

Source: microsoft/knowledge/breaking-changes/relocating-a-field-to-a-tableextension-is-not-a-deletion.md
