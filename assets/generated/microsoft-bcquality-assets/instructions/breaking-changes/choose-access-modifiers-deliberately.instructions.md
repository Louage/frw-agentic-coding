---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/breaking-changes/choose-access-modifiers-deliberately.md
---

# Choose access modifiers deliberately

Source: microsoft/knowledge/breaking-changes/choose-access-modifiers-deliberately.md
