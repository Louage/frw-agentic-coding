---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/ui/control-add-in-accessibility-is-developer-responsibility.md
---

# Control add-in accessibility is the developer's responsibility

Source: microsoft/knowledge/ui/control-add-in-accessibility-is-developer-responsibility.md
