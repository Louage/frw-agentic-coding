---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/ui/style-expr-text-vs-boolean.md
---

# StyleExpr: Boolean toggle vs Text variable

Source: microsoft/knowledge/ui/style-expr-text-vs-boolean.md
