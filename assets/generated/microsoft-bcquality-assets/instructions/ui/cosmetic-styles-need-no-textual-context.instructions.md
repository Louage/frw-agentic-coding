---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/ui/cosmetic-styles-need-no-textual-context.md
---

# Cosmetic styles need no textual context

Source: microsoft/knowledge/ui/cosmetic-styles-need-no-textual-context.md
