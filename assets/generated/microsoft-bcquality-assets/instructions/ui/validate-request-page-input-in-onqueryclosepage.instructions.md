---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/ui/validate-request-page-input-in-onqueryclosepage.md
---

# Validate request-page input in OnQueryClosePage, not only in OnPreReport

Source: microsoft/knowledge/ui/validate-request-page-input-in-onqueryclosepage.md
