---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/ui/split-button-standard-groups.md
---

# Reserve `ShowAs = SplitButton` For Standard Posting And Release Groups

Source: community/knowledge/ui/split-button-standard-groups.md
