---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/ui/group-labeled-first-child-exception.md
---

# Group-labeled first child exception

Source: microsoft/knowledge/ui/group-labeled-first-child-exception.md
