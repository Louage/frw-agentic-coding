---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/interfaces/prefer-interface-over-case-branching.md
---

# Prefer an interface with enum-backed implementation over a case statement for variant behaviour

Source: microsoft/knowledge/interfaces/prefer-interface-over-case-branching.md
