---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/interfaces/set-defaultimplementation-on-enum.md
---

# Set DefaultImplementation on an enum so an unmapped value still resolves to an interface

Source: microsoft/knowledge/interfaces/set-defaultimplementation-on-enum.md
