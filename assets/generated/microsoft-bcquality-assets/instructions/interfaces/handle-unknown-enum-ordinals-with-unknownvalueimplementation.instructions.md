---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/interfaces/handle-unknown-enum-ordinals-with-unknownvalueimplementation.md
---

# Handle unknown enum ordinals with UnknownValueImplementation

Source: microsoft/knowledge/interfaces/handle-unknown-enum-ordinals-with-unknownvalueimplementation.md
