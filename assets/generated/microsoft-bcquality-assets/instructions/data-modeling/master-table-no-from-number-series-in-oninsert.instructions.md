---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/master-table-no-from-number-series-in-oninsert.md
---

# A master table's `No.` primary key comes from a number series in `OnInsert`

Source: microsoft/knowledge/data-modeling/master-table-no-from-number-series-in-oninsert.md
