---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/transferfields-skip-type-mismatch-can-drop-data.md
---

# Do not use SkipFieldsNotMatchingType to hide required TransferFields mismatches

Source: microsoft/knowledge/data-modeling/transferfields-skip-type-mismatch-can-drop-data.md
