---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/table-relation-extensions-are-additive-and-top-down.md
---

# Design TableRelation branches for additive top-down extension

Source: microsoft/knowledge/data-modeling/table-relation-extensions-are-additive-and-top-down.md
