---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/insert-only-transfer-may-rely-on-caller-cleanup.md
---

# An insert-only transfer routine may rely on cleanup its caller already performed

Source: microsoft/knowledge/data-modeling/insert-only-transfer-may-rely-on-caller-cleanup.md
