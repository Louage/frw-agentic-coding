---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/use-no-series-codeunit-not-noseriesmanagement.md
---

# Assign numbers with codeunit `"No. Series"`, not the obsolete `NoSeriesManagement`

Source: microsoft/knowledge/data-modeling/use-no-series-codeunit-not-noseriesmanagement.md
