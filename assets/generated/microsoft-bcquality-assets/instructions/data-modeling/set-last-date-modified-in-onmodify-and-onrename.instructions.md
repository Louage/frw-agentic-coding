---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/set-last-date-modified-in-onmodify-and-onrename.md
---

# Refresh `Last Date Modified` in both `OnModify` and `OnRename`

Source: microsoft/knowledge/data-modeling/set-last-date-modified-in-onmodify-and-onrename.md
