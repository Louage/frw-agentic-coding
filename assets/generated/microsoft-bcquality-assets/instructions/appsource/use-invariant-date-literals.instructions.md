---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/appsource/use-invariant-date-literals.md
---

# Use invariant date literals

Source: community/knowledge/appsource/use-invariant-date-literals.md
