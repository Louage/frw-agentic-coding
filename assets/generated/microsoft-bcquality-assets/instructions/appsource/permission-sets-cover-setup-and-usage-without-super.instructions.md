---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/appsource/permission-sets-cover-setup-and-usage-without-super.md
---

# AppSource permission sets must cover setup and usage without SUPER

Source: microsoft/knowledge/appsource/permission-sets-cover-setup-and-usage-without-super.md
