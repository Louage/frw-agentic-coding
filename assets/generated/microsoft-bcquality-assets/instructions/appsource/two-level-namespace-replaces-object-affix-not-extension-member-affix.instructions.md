---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/appsource/two-level-namespace-replaces-object-affix-not-extension-member-affix.md
---

# A two-level namespace replaces an object affix, not an extension-member affix

Source: microsoft/knowledge/appsource/two-level-namespace-replaces-object-affix-not-extension-member-affix.md
