---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/changecompany-runs-triggers-in-the-calling-company.md
---

# ChangeCompany leaves triggers and trigger-event subscribers running in the calling company

Source: microsoft/knowledge/events/changecompany-runs-triggers-in-the-calling-company.md
