---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/reset-ishandled-only-when-the-value-can-carry-over.md
---

# Reset IsHandled before publishing only when its value can carry over

Source: microsoft/knowledge/events/reset-ishandled-only-when-the-value-can-carry-over.md
