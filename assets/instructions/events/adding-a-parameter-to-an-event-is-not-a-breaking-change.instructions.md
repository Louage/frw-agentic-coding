---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/adding-a-parameter-to-an-event-is-not-a-breaking-change.md
---

# Adding a parameter to an event is not a breaking change

Source: microsoft/knowledge/events/adding-a-parameter-to-an-event-is-not-a-breaking-change.md
