---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/events/add-new-event-parameters-at-the-end.md
---

# Add new event parameters at the end

Source: microsoft/knowledge/events/add-new-event-parameters-at-the-end.md
