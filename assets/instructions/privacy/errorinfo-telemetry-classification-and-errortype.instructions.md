---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/errorinfo-telemetry-classification-and-errortype.md
---

# Review each ErrorInfo text surface by its actual exposure

Source: microsoft/knowledge/privacy/errorinfo-telemetry-classification-and-errortype.md
