---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/featuretelemetry-customdimensions-no-pii.md
---

# `FeatureTelemetry` `CustomDimensions` follow the same privacy rules as `Session.LogMessage`

Source: microsoft/knowledge/privacy/featuretelemetry-customdimensions-no-pii.md
