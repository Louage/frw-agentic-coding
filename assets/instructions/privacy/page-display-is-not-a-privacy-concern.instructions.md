---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/page-display-is-not-a-privacy-concern.md
---

# Displaying fields on a page (or in a UI dialog) is not a privacy concern

Source: microsoft/knowledge/privacy/page-display-is-not-a-privacy-concern.md
