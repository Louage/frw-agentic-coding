---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/error-direct-substitution-safe-for-telemetry.md
---

# `Error()` with direct substitution parameters is always safe for telemetry

Source: microsoft/knowledge/privacy/error-direct-substitution-safe-for-telemetry.md
