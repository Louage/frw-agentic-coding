---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/privacy/avoid-strsubstno-prebuild-before-error.md
---

# Pass a Label directly as the first Error argument

Source: microsoft/knowledge/privacy/avoid-strsubstno-prebuild-before-error.md
