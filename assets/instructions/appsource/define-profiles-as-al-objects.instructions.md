---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/appsource/define-profiles-as-al-objects.md
---

# Define profiles as AL objects

Source: community/knowledge/appsource/define-profiles-as-al-objects.md
