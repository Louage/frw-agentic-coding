---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/testing/asserterror-needs-expectederror-and-code.md
---

# Pin asserterror to a specific error with ExpectedError and ExpectedErrorCode

Source: microsoft/knowledge/testing/asserterror-needs-expectederror-and-code.md
