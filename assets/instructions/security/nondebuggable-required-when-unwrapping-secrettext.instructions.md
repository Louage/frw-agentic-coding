---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/nondebuggable-required-when-unwrapping-secrettext.md
---

# On-premises only: protect unavoidable SecretText.Unwrap calls

Source: microsoft/knowledge/security/nondebuggable-required-when-unwrapping-secrettext.md
