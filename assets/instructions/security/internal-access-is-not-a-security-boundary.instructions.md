---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/internal-access-is-not-a-security-boundary.md
---

# Access Internal is API hygiene, not an authorization boundary

Source: microsoft/knowledge/security/internal-access-is-not-a-security-boundary.md
