---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/security/al-has-no-built-in-htmlencode.md
---

# AL has no built-in HtmlEncode — encode HTML output by hand or avoid it

Source: microsoft/knowledge/security/al-has-no-built-in-htmlencode.md
