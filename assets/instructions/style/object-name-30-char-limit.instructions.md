---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/object-name-30-char-limit.md
---

# Keep object names within the 30-character platform limit

Source: microsoft/knowledge/style/object-name-30-char-limit.md
