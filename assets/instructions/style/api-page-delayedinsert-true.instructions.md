---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/api-page-delayedinsert-true.md
---

# Set `DelayedInsert = true` on API pages

Source: microsoft/knowledge/style/api-page-delayedinsert-true.md
