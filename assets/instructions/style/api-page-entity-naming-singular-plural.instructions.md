---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/api-page-entity-naming-singular-plural.md
---

# `EntityName` is singular; `EntitySetName` is plural

Source: microsoft/knowledge/style/api-page-entity-naming-singular-plural.md
