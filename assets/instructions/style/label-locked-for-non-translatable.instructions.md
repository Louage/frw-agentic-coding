---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/style/label-locked-for-non-translatable.md
---

# Set `Locked = true` on Labels that must not be translated

Source: microsoft/knowledge/style/label-locked-for-non-translatable.md
