---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/skip-incoming-review-only-for-trusted-input.md
---

# Skip incoming message review only after the caller validated the payload

Source: community/knowledge/agents/skip-incoming-review-only-for-trusted-input.md
