---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/agent-setup-table-keyed-by-user-security-id.md
---

# Agent setup tables are keyed by User Security ID

Source: community/knowledge/agents/agent-setup-table-keyed-by-user-security-id.md
