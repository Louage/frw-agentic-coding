---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/register-copilot-capability-for-the-agent.md
---

# Register a Copilot capability for the agent on install

Source: community/knowledge/agents/register-copilot-capability-for-the-agent.md
