---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/set-instructions-as-secrettext.md
---

# Set agent instructions as SecretText on the instance

Source: community/knowledge/agents/set-instructions-as-secrettext.md
