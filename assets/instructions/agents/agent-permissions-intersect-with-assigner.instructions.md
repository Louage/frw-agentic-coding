---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/agent-permissions-intersect-with-assigner.md
---

# Agent permissions intersect the assigner's; agents cannot configure users

Source: community/knowledge/agents/agent-permissions-intersect-with-assigner.md
