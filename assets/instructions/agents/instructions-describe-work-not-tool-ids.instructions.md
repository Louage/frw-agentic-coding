---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/instructions-describe-work-not-tool-ids.md
---

# Instructions describe outcomes, not page action or tool names

Source: community/knowledge/agents/instructions-describe-work-not-tool-ids.md
