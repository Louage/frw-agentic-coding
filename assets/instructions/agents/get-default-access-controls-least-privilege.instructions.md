---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/get-default-access-controls-least-privilege.md
---

# Default agent permission sets must exist in AL and stay least privilege

Source: community/knowledge/agents/get-default-access-controls-least-privilege.md
