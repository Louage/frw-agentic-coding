---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/agents/do-not-create-agents-in-install-upgrade-or-background.md
---

# Do not create agent instances from install, upgrade, or background sessions

Source: community/knowledge/agents/do-not-create-agents-in-install-upgrade-or-background.md
