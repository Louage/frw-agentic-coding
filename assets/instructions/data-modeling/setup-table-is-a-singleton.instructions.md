---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/setup-table-is-a-singleton.md
---

# A setup table is a singleton: one blank-keyed row, no insert or delete

Source: microsoft/knowledge/data-modeling/setup-table-is-a-singleton.md
