---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/data-modeling/check-blocked-in-referencing-code-not-in-master.md
---

# Enforce `Blocked` where the master is used, not in the master itself

Source: microsoft/knowledge/data-modeling/check-blocked-in-referencing-code-not-in-master.md
