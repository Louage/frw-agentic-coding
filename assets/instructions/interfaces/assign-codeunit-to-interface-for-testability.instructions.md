---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/interfaces/assign-codeunit-to-interface-for-testability.md
---

# Assign a codeunit to an interface variable for injectable, testable dependencies

Source: microsoft/knowledge/interfaces/assign-codeunit-to-interface-for-testability.md
