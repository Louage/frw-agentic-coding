---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/error-handling/fielderror-default-message-logic.md
---

# Rely On FieldError's Auto-Generated Context And Pass Only A Lowercase Predicate

Source: community/knowledge/error-handling/fielderror-default-message-logic.md
