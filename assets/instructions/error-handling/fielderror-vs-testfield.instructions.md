---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/error-handling/fielderror-vs-testfield.md
---

# Choose `TestField` For Conditional Checks And `FieldError` For Already-Failed Validation

Source: microsoft/knowledge/error-handling/fielderror-vs-testfield.md
