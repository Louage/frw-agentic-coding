---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/error-handling/page-boolean-triggers-default-to-true.md
---

# Page record triggers return true by default; a missing exit(true) does not block the operation

Source: microsoft/knowledge/error-handling/page-boolean-triggers-default-to-true.md
