---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/production-scale-tables-warrant-extra-analysis.md
---

# Production-scale tables warrant concrete performance analysis

Source: microsoft/knowledge/performance/production-scale-tables-warrant-extra-analysis.md
