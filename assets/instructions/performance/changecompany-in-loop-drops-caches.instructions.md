---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/changecompany-in-loop-drops-caches.md
---

# Do not call ChangeCompany inside a per-row loop

Source: microsoft/knowledge/performance/changecompany-in-loop-drops-caches.md
