---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/page-background-tasks-for-expensive-cues.md
---

# Calculate expensive cues on a page background task

Source: microsoft/knowledge/performance/page-background-tasks-for-expensive-cues.md
