---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/use-setautocalcfields-for-per-row-flowfields.md
---

# Use SetAutoCalcFields when each iterated row needs a FlowField

Source: microsoft/knowledge/performance/use-setautocalcfields-for-per-row-flowfields.md
