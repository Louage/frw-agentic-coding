---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/singleton-setup-tables-need-no-access-optimization.md
---

# Singleton setup tables hold one row; access-pattern optimization is wasted

Source: microsoft/knowledge/performance/singleton-setup-tables-need-no-access-optimization.md
