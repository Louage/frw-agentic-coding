---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/job-queue-handlers-must-propagate-failures.md
---

# Job queue handlers must propagate execution failures

Source: microsoft/knowledge/performance/job-queue-handlers-must-propagate-failures.md
