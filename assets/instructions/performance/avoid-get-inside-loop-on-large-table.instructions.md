---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/avoid-get-inside-loop-on-large-table.md
---

# Avoid Get / FindFirst inside a loop on a large inner table

Source: microsoft/knowledge/performance/avoid-get-inside-loop-on-large-table.md
