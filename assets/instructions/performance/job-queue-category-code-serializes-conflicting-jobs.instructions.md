---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/job-queue-category-code-serializes-conflicting-jobs.md
---

# Use a job queue category to serialize conflicting jobs

Source: microsoft/knowledge/performance/job-queue-category-code-serializes-conflicting-jobs.md
