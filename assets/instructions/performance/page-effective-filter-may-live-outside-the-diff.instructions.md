---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/page-effective-filter-may-live-outside-the-diff.md
---

# A page or lookup's effective filter may be defined outside the changed hunk

Source: microsoft/knowledge/performance/page-effective-filter-may-live-outside-the-diff.md
