---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/avoid-user-prompts-inside-transactions.md
---

# Do not hold locks while waiting for the user

Source: microsoft/knowledge/performance/avoid-user-prompts-inside-transactions.md
