---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/prefer-dictionary-over-temporary-table-for-lookups.md
---

# Prefer a Dictionary over a temporary table for pure lookups

Source: microsoft/knowledge/performance/prefer-dictionary-over-temporary-table-for-lookups.md
