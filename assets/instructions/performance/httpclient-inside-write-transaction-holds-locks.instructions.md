---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/httpclient-inside-write-transaction-holds-locks.md
---

# Do not call HttpClient inside an open write transaction

Source: microsoft/knowledge/performance/httpclient-inside-write-transaction-holds-locks.md
