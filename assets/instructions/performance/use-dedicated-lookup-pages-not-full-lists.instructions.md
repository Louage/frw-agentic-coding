---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/use-dedicated-lookup-pages-not-full-lists.md
---

# Point lookups at a dedicated lookup page, not the full list

Source: community/knowledge/performance/use-dedicated-lookup-pages-not-full-lists.md
