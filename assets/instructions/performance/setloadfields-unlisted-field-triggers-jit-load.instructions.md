---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/setloadfields-unlisted-field-triggers-jit-load.md
---

# Reading an unlisted field after SetLoadFields triggers a JIT load

Source: community/knowledge/performance/setloadfields-unlisted-field-triggers-jit-load.md
