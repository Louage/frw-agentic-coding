---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/guard-event-subscribers-before-db-call.md
---

# Guard event subscribers with cheap checks before any database call

Source: microsoft/knowledge/performance/guard-event-subscribers-before-db-call.md
