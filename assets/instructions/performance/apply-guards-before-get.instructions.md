---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/apply-guards-before-get.md
---

# Apply early-exit guards before calling Get

Source: microsoft/knowledge/performance/apply-guards-before-get.md
