---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/pair-findset-with-next-loop.md
---

# Use FindSet with repeat..Next; do not pair FindFirst/FindLast/Get with Next

Source: microsoft/knowledge/performance/pair-findset-with-next-loop.md
