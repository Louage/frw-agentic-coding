---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/query-results-bypass-primary-key-cache.md
---

# Query results bypass the primary-key cache

Source: community/knowledge/performance/query-results-bypass-primary-key-cache.md
