---
applyTo: '**/*.al'
description: Imported BCQuality rule from community/knowledge/performance/isempty-before-findset-is-extra-round-trip.md
---

# IsEmpty immediately before FindSet is an extra round-trip

Source: community/knowledge/performance/isempty-before-findset-is-extra-round-trip.md
