---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/primary-key-get-in-loop-is-transaction-cached.md
---

# A primary-key Get() in a per-row helper is not an N+1 to cache manually

Source: microsoft/knowledge/performance/primary-key-get-in-loop-is-transaction-cached.md
