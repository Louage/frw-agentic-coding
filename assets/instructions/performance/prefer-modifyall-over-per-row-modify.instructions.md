---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/prefer-modifyall-over-per-row-modify.md
---

# Use ModifyAll only for equivalent bulk assignments

Source: microsoft/knowledge/performance/prefer-modifyall-over-per-row-modify.md
