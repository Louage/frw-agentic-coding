---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/performance/do-not-locktable-in-read-only-procedure.md
---

# Do not LockTable in a read-only procedure

Source: microsoft/knowledge/performance/do-not-locktable-in-read-only-procedure.md
