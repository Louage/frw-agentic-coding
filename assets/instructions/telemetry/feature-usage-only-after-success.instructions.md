---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/telemetry/feature-usage-only-after-success.md
---

# Call FeatureTelemetry.LogUsage only after successful use

Source: microsoft/knowledge/telemetry/feature-usage-only-after-success.md
