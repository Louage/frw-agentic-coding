---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/ui/control-addin-throttle-al-calls-and-payload-size.md
---

# Serialize control add-in AL calls and keep payloads small

Source: microsoft/knowledge/ui/control-addin-throttle-al-calls-and-payload-size.md
