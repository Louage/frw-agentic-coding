---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/ui/group-caption-quality-is-not-an-accessibility-issue.md
---

# Group caption quality is not an accessibility issue

Source: microsoft/knowledge/ui/group-caption-quality-is-not-an-accessibility-issue.md
