---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/breaking-changes/unreleased-symbol-change-is-not-a-breaking-change.md
---

# Changing an unreleased symbol is not a breaking change

Source: microsoft/knowledge/breaking-changes/unreleased-symbol-change-is-not-a-breaking-change.md
