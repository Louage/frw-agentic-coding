---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/breaking-changes/do-not-change-published-procedure-signatures.md
---

# Do not change the signature of a published procedure

Source: microsoft/knowledge/breaking-changes/do-not-change-published-procedure-signatures.md
