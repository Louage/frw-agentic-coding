---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/breaking-changes/obsolete-table-fields-instead-of-deleting-them.md
---

# Obsolete published table fields instead of deleting, renaming, or renumbering them

Source: microsoft/knowledge/breaking-changes/obsolete-table-fields-instead-of-deleting-them.md
