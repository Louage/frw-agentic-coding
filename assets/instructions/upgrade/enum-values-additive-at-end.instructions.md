---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/enum-values-additive-at-end.md
---

# Add new enum values only at the end

Source: microsoft/knowledge/upgrade/enum-values-additive-at-end.md
