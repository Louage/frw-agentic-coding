---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/unreleased-schema-change-needs-no-upgrade-path.md
---

# Unreleased schema changes need no upgrade or migration path

Source: microsoft/knowledge/upgrade/unreleased-schema-change-needs-no-upgrade-path.md
