---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/obsoletereason-need-not-restate-removal-version.md
---

# ObsoleteReason need not restate the removal version; ObsoleteTag carries it

Source: microsoft/knowledge/upgrade/obsoletereason-need-not-restate-removal-version.md
