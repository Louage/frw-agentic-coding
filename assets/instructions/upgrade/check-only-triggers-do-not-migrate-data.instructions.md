---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/check-only-triggers-do-not-migrate-data.md
---

# Upgrade check triggers do not migrate data

Source: microsoft/knowledge/upgrade/check-only-triggers-do-not-migrate-data.md
