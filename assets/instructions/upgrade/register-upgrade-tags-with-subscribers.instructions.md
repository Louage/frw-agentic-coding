---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/register-upgrade-tags-with-subscribers.md
---

# Register every upgrade tag with the platform via an event subscriber

Source: microsoft/knowledge/upgrade/register-upgrade-tags-with-subscribers.md
