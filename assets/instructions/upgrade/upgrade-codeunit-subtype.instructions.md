---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/upgrade/upgrade-codeunit-subtype.md
---

# Upgrade logic must live in a codeunit with `Subtype = Upgrade`

Source: microsoft/knowledge/upgrade/upgrade-codeunit-subtype.md
