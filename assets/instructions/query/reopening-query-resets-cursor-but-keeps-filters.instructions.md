---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/query/reopening-query-resets-cursor-but-keeps-filters.md
---

# Reopening a Query resets its cursor but keeps its filters

Source: microsoft/knowledge/query/reopening-query-resets-cursor-but-keeps-filters.md
