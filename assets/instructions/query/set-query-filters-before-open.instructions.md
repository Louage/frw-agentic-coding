---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/query/set-query-filters-before-open.md
---

# Set Query filters before Open

Source: microsoft/knowledge/query/set-query-filters-before-open.md
