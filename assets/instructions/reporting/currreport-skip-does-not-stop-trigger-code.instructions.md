---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/reporting/currreport-skip-does-not-stop-trigger-code.md
---

# CurrReport.Skip omits the record but does not stop trigger code

Source: microsoft/knowledge/reporting/currreport-skip-does-not-stop-trigger-code.md
