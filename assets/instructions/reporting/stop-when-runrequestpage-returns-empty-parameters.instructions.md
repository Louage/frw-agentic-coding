---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/reporting/stop-when-runrequestpage-returns-empty-parameters.md
---

# Stop when RunRequestPage returns empty parameters

Source: microsoft/knowledge/reporting/stop-when-runrequestpage-returns-empty-parameters.md
