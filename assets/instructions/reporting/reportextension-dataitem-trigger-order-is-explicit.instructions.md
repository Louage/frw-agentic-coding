---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/reporting/reportextension-dataitem-trigger-order-is-explicit.md
---

# Choose ReportExtension dataitem triggers by their order around the base trigger

Source: microsoft/knowledge/reporting/reportextension-dataitem-trigger-order-is-explicit.md
