---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/web-services/webhook-eligibility-and-validationtoken-renewal.md
---

# Verify webhook eligibility and complete every validationToken handshake

Source: microsoft/knowledge/web-services/webhook-eligibility-and-validationtoken-renewal.md
