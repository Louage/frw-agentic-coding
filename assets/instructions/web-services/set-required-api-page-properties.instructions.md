---
applyTo: '**/*.al'
description: Imported BCQuality rule from microsoft/knowledge/web-services/set-required-api-page-properties.md
---

# Declare every required property on a PageType = API page

Source: microsoft/knowledge/web-services/set-required-api-page-properties.md
