...
description: "Reviews AL source changes against the `style` knowledge domain in BCQuality and emits a findings report."
---

# AL style review

Source: microsoft/skills/review/al-style-review.md
