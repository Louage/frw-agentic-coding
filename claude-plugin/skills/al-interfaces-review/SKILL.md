---
name: "al-interfaces-review"
description: "Reviews AL source changes against the `interfaces` knowledge domain in BCQuality and emits a findings report."
---

# AL interfaces review

Source: microsoft/skills/review/al-interfaces-review.md
