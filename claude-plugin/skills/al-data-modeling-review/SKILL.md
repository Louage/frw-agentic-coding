---
name: "al-data-modeling-review"
description: "Reviews AL source changes against the `data-modeling` knowledge domain in BCQuality and emits a findings report."
---

# AL data-modeling review

Source: microsoft/skills/review/al-data-modeling-review.md
