---
name: "al-telemetry-review"
description: "Reviews AL source changes against the `telemetry` knowledge domain in BCQuality and emits a findings report."
---

# AL telemetry review

Source: microsoft/skills/review/al-telemetry-review.md
