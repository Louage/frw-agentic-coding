---
name: "al-events-review"
description: "Reviews AL source changes against the `events` knowledge domain in BCQuality and emits a findings report."
---

# AL events review

Source: microsoft/skills/review/al-events-review.md
