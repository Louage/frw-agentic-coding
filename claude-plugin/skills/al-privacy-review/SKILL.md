...
description: "Reviews AL source changes against the `privacy` knowledge domain in BCQuality and emits a findings report."
---

# AL privacy review

Source: microsoft/skills/review/al-privacy-review.md
