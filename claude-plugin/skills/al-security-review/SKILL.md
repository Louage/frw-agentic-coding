...
description: "Reviews AL source changes against the `security` knowledge domain in BCQuality and emits a findings report."
---

# AL security review

Source: microsoft/skills/review/al-security-review.md
