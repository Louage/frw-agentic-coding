...
description: "Reviews AL source changes against the `upgrade` knowledge domain in BCQuality and emits a findings report."
---

# AL upgrade review

Source: microsoft/skills/review/al-upgrade-review.md
