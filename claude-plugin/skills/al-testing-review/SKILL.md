---
name: "al-testing-review"
description: "Reviews AL source changes against the `testing` knowledge domain in BCQuality and emits a findings report."
---

# AL testing review

Source: microsoft/skills/review/al-testing-review.md
