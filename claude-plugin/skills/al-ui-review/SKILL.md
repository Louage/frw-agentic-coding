---
name: "al-ui-review"
description: "Reviews AL page source and control add-in UI files against the `ui` knowledge domain in BCQuality and emits a findings report."
---

# AL UI and accessibility review

Source: microsoft/skills/review/al-ui-review.md
